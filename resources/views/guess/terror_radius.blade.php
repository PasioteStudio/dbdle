        ...
        <div class="grid gap-6 lg:grid-cols-1 lg:gap-8 text-center col-lg-4 mx-auto col-md-12 ">
            ...
            >
                ...
                <div class="pt-3 sm:pt-5 w-100">
                    <h2 class="fs-3 font-semibold text-white dark:text-white  ">Guess the random perk!</h2>
                </div>
            </a>
            <a
            ...
            >
                ...
                <div class="pt-3 sm:pt-5 w-100 d-grid" style="justify-items: center; background: url('{{$veryrare_perk_bg}}') no-repeat center;background-size: contain;">
