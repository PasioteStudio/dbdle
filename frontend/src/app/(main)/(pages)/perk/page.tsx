  ...
  return (
    <div>
      ...
      <div className="grid text-center -mt-20">
        <ExportedImage  src={"/imgs/effects/ui_cloud.webp"} fetchPriority="high" priority unoptimized alt="" width={500} height={500} className="grid-column-1 w-full   -z-10 " />
        <div className="grid-column-1 mt-25">
          ...
          <div className="p-5 w-[50%] mx-auto aspect-square justify-items-center items-center grid bg-no-repeat bg-contain bg-center" style={{backgroundImage:`url('${perkBg}')`}}>
            <ExportedImage  src={process.env.NEXT_PUBLIC_HOST + "/perk/image"} fetchPriority="high" priority unoptimized className="w-full" alt="unknown perk" width={500} height={500} />
          </div>
          {missCount < 6 || isFound ? 
